...
[![Jetpack Compose](https://img.shields.io/badge/Jetpack_Compose-BOM_2024.09-4285F4?style=for-the-badge&logo=android&logoColor=white)](https://developer.android.com/jetpack/compose)
[![Android](https://img.shields.io/badge/Platform-Android_8.0_to_15-34A853?style=for-the-badge&logo=android&logoColor=white)](https://android.com)
[![Privacy](https://img.shields.io/badge/100%25-Local_First_%26_Private-00C853?style=for-the-badge&logo=shield&logoColor=white)]()
...
```mermaid
flowchart LR
    A["🚀 App Launch"] --> B["⚡ Instant Spec Discovery\n& Gyro 3D Chassis"]
    B --> C["📡 Laser Sonar Sweep\n(CPU, RAM, PMIC, AMOLED)"]
    C --> D["💥 Shockwave Score Reveal\n(Overall Health 0–100)"]
    D --> E["🎛️ Command Center\n(Live Telemetry & Diagnostics)"]
```
